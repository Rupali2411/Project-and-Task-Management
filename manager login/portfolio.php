                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Progress</th>
                            <th>Report</th> <!-- New column for the button -->
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        // Query to fetch projects associated with the logged-in manager
                        $managerProjectsQuery = "SELECT * FROM projectsnew WHERE manager_id = '$managerId'";
                        $managerProjectsResult = mysqli_query($conn, $managerProjectsQuery);

                        if ($managerProjectsResult && mysqli_num_rows($managerProjectsResult) > 0) {
                            // Loop through each project and display its details
                            while ($project = mysqli_fetch_assoc($managerProjectsResult)) {
                                // Calculate progress
...
echo "</td>";
                            ...
                            echo "<tr><td colspan='5'>No projects found for this manager.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
