...
if (isset($_POST['update'])) {
    ...
    $empName = mysqli_real_escape_string($conn, $_POST['manager_name']);
    ...
    $query = "UPDATE managers_login SET 
              manager_name='$empName', 
              contact='$contact', 
              email_id='$emailId', 
              manager_password='$empPassword' 
              WHERE manager_id='$empId'";

    if (mysqli_query($conn, $query)) {
        // Update successful, redirect to dash.php
...
<form class="styled-form needs-validation" method="post" action="editmanagr.php" enctype="multipart/form-data" novalidate onsubmit="return validateForm()">



        <div class="form-row">
        <div class="form-group col-md-6">
            <input type="text" class="form-control" id="managerid" onkeyup="validateEmpId()" name="manager_id" value="<?php echo $employeeDetails['manager_id']; ?>" placeholder="Manager ID" pattern="[A-Za-z0-9]+" title="Not editable" readonly>
        ...
        <div class="form-group col-md-6" >
            <input type="text" class="form-control" id="name"  onkeyup="validateEmpName()" name="manager_name" value="<?php echo $employeeDetails['manager_name']; ?>" placeholder="Manager Name" pattern="[A-Za-z ]+" title="Only characters allowed" required>
            <div class="valid-feedback">
                Looks good!
            </div>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <input type="text" class="form-control" id="contact" onkeyup="validateContact()" name="contact" value="<?php echo $employeeDetails['contact']; ?>" placeholder="Contact" pattern="[0-9]{10}" title="Only 10 digits number" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
      ...
      <div class="form-group col-md-6">
        <input type="text" class="form-control" id="email" onkeyup="validateEmail()" name="email_id"  value="<?php echo $employeeDetails['email_id']; ?>"placeholder="Email Address" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
    ...
    <div class="form-row">
      <div class="form-group col-md-6" >
        <input type="password" class="form-control" id="mangr_password" onkeyup="validatePassword()" value="<?php echo $employeeDetails['manager_password']; ?>" name="manager_password" placeholder="Password" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
...
<br>
    ...
    <button type="submit" class="btn btn-primary btn-block" name="update" onclick="message(false)">Submit</button>
