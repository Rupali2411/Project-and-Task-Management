...
if (isset($_SESSION['emp_id'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (isset($_POST['add'])) {
            ...
            $insertQuery = "INSERT INTO todo_employee (task, status, emp_id) VALUES ('$task', '', '$empId')";
        ...
        $tasksQuery = "SELECT * FROM todo_employee WHERE emp_id = '$empId' ORDER BY task_id ASC";
 ...
 <section id="sidebar">
                <div class="brand">
                    <span id="text">Manager Details</span><br>
                        <p1>Name: <?php echo $employee['emp_name']; ?> </p1><br>
                        <p1>Manager ID: <?php echo $employee['emp_id']; ?> </p1>
                </div>
                <div class="user-box">
                    <div class="user-info">
