...
<body>
    ...
    if (passwordPattern.test(passwordInput)) {
        document.getElementById('emp_password').classList.remove('is-invalid');
        document.getElementById('emp_password').classList.add('is-valid');
        return true;
    } else {
        document.getElementById('emp_password').classList.remove('is-valid');
        document.getElementById('emp_password').classList.add('is-invalid');
        return false;
    }
}
...
<form class="styled-form needs-validation" method="post" action="process_registration.php" enctype="multipart/form-data" novalidate onsubmit="return validateForm()">
      ...
      <div class="form-row">
            <div class="form-group col-md-6">
                <input type="text" class="form-control" id="empid" onkeyup="validateEmpId()" name="emp_id" placeholder="Emp ID" pattern="[A-Za-z0-9]+" title="Only characters and numbers allowed" required>
            ...
            <div class="form-group col-md-6" style="padding-left:20px;">
                <input type="text" class="form-control" id="empname"  onkeyup="validateEmpName()" name="emp_name" placeholder="Employee Name" pattern="[A-Za-z ]+" title="Only characters allowed" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                    <div class="invalid-feedback">
    ...
    <script>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <select class="form-control" class="form-control" id="inputdepartment" name="department" oninput="validateDepartment()" list="departmentOptions"  required>
                                ...
                                <option value="Operations/Operations Management">Operations/Operations Management</option>
                                ...
                                <option value="Public Affairs/Government Relations">Public Affairs/Government Relations</option>
                                <option value="Environmental, Social, and Governance (ESG)">Environmental, Social, and Governance (ESG)</option>
                            </select>
      ...
      <div class="form-group col-md-6" style="padding-left:20px;">
        <input type="password" class="form-control" id="emp_password" onkeyup="validatePassword()" name="emp_password" placeholder="Password" required>
        <div class="valid-feedback">
          Looks good!
        </div>
        <div class="invalid-feedback">
...
<br>
    ...
    function message(duplicateEntry) {
        ...
        var deprtInput = document.getElementById('inputdepartment'); // Corrected the ID here
