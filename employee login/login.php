...
var empIdInput = document.getElementById('emp_id').value;   
...
function validateEmpId() {
  ...
  if (empIdPattern.test(empIdInput)) {
    document.getElementById('emp_id').classList.remove('is-invalid');
    document.getElementById('emp_id').classList.add('is-valid');
    return true;
  } else {
    document.getElementById('emp_id').classList.remove('is-valid');
					...
					<div id="card-form" class="card fat">
						<div class="card-body">
                            ...
                            <form class="styled-form needs-validation" method="post" action="process_login.php" enctype="multipart/form-data" novalidate onsubmit="return validateEmpId()">
								...
								<div class="form-group" >
                                        <label for="emp_password" class="form-label">Password
                              ...
                              <br>
								...
								<div class="mt-4 text-center" >
                                    Don't have an account? <a href="new_register_form.php" style="color: aqua;">Create One</a>
                                </div>
